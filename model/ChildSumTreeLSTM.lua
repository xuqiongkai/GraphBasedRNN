...
local ChildSumTreeLSTM, parent = torch.class('classifier.ChildSumTreeLSTM', 'classifier.TreeLSTM')
...
--  local child_h_pool = nn.Sum(1)(child_h)
--  local child_h_pool = nn.Mean(1)(child_h)
  local i = nn.Sigmoid()(
    nn.CAddTable(){
